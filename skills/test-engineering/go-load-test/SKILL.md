...
This validates the Service Level Objectives the NFR specification sets and the `slo-definition` skill formalises (Chunk 15), using the RED/USE telemetry the services already emit (`opentelemetry-instrumentation`).
