...
2. Read `skills/governance/artifact-manifest/SKILL.md` for the master artifact-type catalog and, once it exists, the product's own `artifacts/[product]/_manifest.json`.
